  ...
  >
      ...
      <h2 className='text-3xl font-bold mb-6 text-center bg-gradient-to-r from-[#ec9569]  to-[#EA6601] text-transparent bg-clip-text'>
        ...
        <motion.div
				...
				>
					<h3 className='text-xl font-semibold text-amber-600 mb-3'>Profile Information</h3>
        ...
        <motion.div
				...
				>
					<h3 className='text-xl font-semibold text-amber-600 mb-3'>Account Activity</h3>
        ...
        <motion.div
			...
			>
				...
				font-bold rounded-lg shadow-lg hover:from-amber-600 hover:to-amber-700
